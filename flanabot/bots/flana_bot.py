...
class FlanaBot(MultiBot, ABC):
    ...
    async def _on_roles(self, message: Message):
        # noinspection PyTypeChecker
        user_role_names = [discord_role.name for discord_role in await self.get_current_roles(message.author.original_object)]
    ...
    async def _on_roles_button_press(self, message: Message):
        ...
        user_role_names = [discord_role.name for discord_role in await self.get_current_roles(message.buttons_info.presser_user.original_object)]
